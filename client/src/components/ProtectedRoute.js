      ...
      <div className='flex gap-2 w-full h-full h-100'>
        <div className='sidebar'>
          <div className='menu'>
            {menu.map((item, index) => {
              return (<div
                className={`menu-item
                  ${getActiveOrNot(item.paths) && "active-menu-item"
                  }`}
                key={index}
        ...
        <div className='body'>
          <div className='header flex justify-between'>
            ...
            ></i>}
            <h1 className='text-2xl'>CHETU QUIZ</h1>
            <div>
              <div className="flex gap-1 items-center">
                <h1 className="text-md text-white">{user?.user_name}</h1>
              </div>
