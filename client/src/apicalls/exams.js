...
export const editQuestionById = async (payload) => {
    try {
        const response = await axiosInstance.post("/api/exams/edit-question-by-id", payload);
        return response.data;
    } catch (error) {
        return error.response.data;
    }
...
export const deleteQuestionById = async (payload) => {
    try {
        const response = await axiosInstance.post("/api/exams/delete-question-by-id", payload);
        return response.data;
    } catch (error) {
        return error.response.data;        
    }
